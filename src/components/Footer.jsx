...
const socials = [
  {
    label: 'GitHub',
    href: 'https://github.com/brauliostefano',
  },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/brauliostefano/',
  },
  {
    label: 'CodePen',
      ...
      <div className="container">
        <div className="lg:grid lg:grid-cols-2 reveal-up">
          <div className="mb-10">
            ...
            {/* <ButtonPrimary
                            href="mailto:brauliostefanov@gmail.com"
                            label="Start project"
                            icon="chevron_right"
                            classes="reveal-up"
                        /> */}
        ...
        <div className="flex items-center justify-between pt-10 mb-8">
          <a href="/" className="logo reveal-up">
            <img src="/images/favicon1.svg" width={40} height={40} alt="logo" />
          </a>
